  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
      <Card className="border border-slate-200/70 bg-white/95 shadow-sm">
        <CardHeader>
          <CardTitle className="text-base">Attempts per Test</CardTitle>
          <CardDescription>Total completed attempts</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="border border-slate-200/70 bg-white/95 shadow-sm">
        <CardHeader>
          <CardTitle className="text-base">Pass Rate % per Test</CardTitle>
          <CardDescription>Based on {'>'}= 70% threshold</CardDescription>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={chartData} margin={{ top: 4, right: 8, left: -10, bottom: 40 }}>
