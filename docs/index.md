...
W2-F7 ──► W4-F1  (reporting scaffold absorbed into W2-F7)
```
...
| File | Needed for |
|---|---|
| `feature_specs/w3-f7-review-remediation.md` | W3-F7 spec (trainer-defined; items live in `features/w3-f7-review-remediation.md`) |
