...
| ------ | --------------------------------------------------- | -------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | -------- |
| W2-F1  | Nginx path-based routing & local TLS                | 🟡 In Progress | [features/w2-f1-nginx-routing-tls.md](features/w2-f1-nginx-routing-tls.md)             | [feature_specs/w2-f1-nginx-routing-tls.md](feature_specs/w2-f1-nginx-routing-tls.md)                     | —        |
...
| W2-F7  | Alembic migrations & Category domain                | ❌ Not Started | [features/w2-f7-alembic-category-domain.md](features/w2-f7-alembic-category-domain.md) | [feature_specs/w2-f7-alembic-category-domain.md](feature_specs/w2-f7-alembic-category-domain.md)         | —        |
...
| W3-F2 | Scoring engine + pessimistic locking                 | ❌ Not Started | [features/w3-f2-scoring-engine-locking.md](features/w3-f2-scoring-engine-locking.md)               | [feature_specs/w3-f2-scoring-engine-locking.md](feature_specs/w3-f2-scoring-engine-locking.md)               | —                                                                                    |
| W3-F3 | Test-taking frontend skeleton (`/take/[testId]`)     | ❌ Not Started | [features/w3-f3-test-taking-frontend-skeleton.md](features/w3-f3-test-taking-frontend-skeleton.md) | [feature_specs/w3-f3-test-taking-frontend-skeleton.md](feature_specs/w3-f3-test-taking-frontend-skeleton.md) | —                                                                                    |
...
| ID    | Title                                                        | Status         | `features/`                                                                                    | `feature_specs/`                                                                                         | `plans/` |
| ----- | ------------------------------------------------------------ | -------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | -------- |
| W4-F1 | Candidate results reporting endpoints                        | ❌ Not Started | [features/w4-f1-results-reporting-endpoints.md](features/w4-f1-results-reporting-endpoints.md) | [feature_specs/w4-f1-results-reporting-endpoints.md](feature_specs/w4-f1-results-reporting-endpoints.md) | —        |
