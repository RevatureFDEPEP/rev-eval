...
async def verify_jwt_token(
    ...
    The token is taken from the ``Authorization: Bearer`` header, injected by
    the Next.js BFF (the single auth-injection point). The gateway is
    Bearer-only — there is no cookie fallback.
    """
